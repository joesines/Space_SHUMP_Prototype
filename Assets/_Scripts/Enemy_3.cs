...
public class Enemy_3 : Enemy
{
    ...
    //Enemy_3 will move following a bezier curve, which is linear
    //interpolation between more than two points. 
    public Vector3[] points;
    public float birthTime;
    public float lifeTime = 10;

    //Again, stat works well because it is not used by Enemy 
    ...
    void Start()
    {
        ...
        //The start position has already been set by Main.Spawn Enemy()
        points[0] = pos;
        ...
        v.x = Random.Range(Utils.camBounds.min.y, 0);
        points[1] = v;
