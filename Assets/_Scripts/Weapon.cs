...
// Items marked [NI] are Not Implemented in this book
...
// The WeaponsDefinition class allows you to set the properties
...
public class WeaponDefinition
{
    ...
    public Color color = Color.white; // Color of Callar & power-up
